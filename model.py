# Doduo's model.py file from their github repository: https://github.com/megagonlabs/doduo
...
# class RobertaModelMultiOutput(BertModelMultiOutput):
#     r"""
...
class BertModelMultiOutput(BertPreTrainedModel):
    ...
    Examples::
        ...
        #print(len(embedding_output[1]))
        #print(len(embedding_output[1][0]))
...
# class RobertaForMultiOutputClassification(BertPreTrainedModel):
#     r"""
...
#         self.roberta = RobertaModelMultiOutput(config)
