...
# TODO add another serialization
    ...
    for epoch in range(args.epoch):
        for task_number, (task, model, train_dataset, valid_dataset, train_dataloader,
            ...
            if vl_micro_f1 > best_vl_micro_f1s[task_number]:
                ...
                model_savepath = "model/{}_{}_{}_{}-bs-{}_ml-{}_seed-{}_ws-{}_preprocess-{}_aug-{}.pt".format(method, task, serialization, args.model_name, args.batch_size, args.max_length, args.random_seed, args.window_size, args.preprocess, args.aug)
    ...
    for task, epoch_evaluation in zip(tasks, epoch_evaluation_results):
        ...
        loss_info_df.to_csv("reports/{}_{}_{}_{}-bs-{}_ml-{}_seed-{}_ws-{}_preprocess-{}_aug-{}_info.csv".format(method, task, serialization, args.model_name, args.batch_size, args.max_length, args.random_seed, args.window_size, args.preprocess, args.aug))

# prediction
    for task in tasks:

        model_path = "model/{}_{}_{}_{}-bs-{}_ml-{}_seed-{}_ws-{}_preprocess-{}_aug-{}.pt".format(method, task, serialization, args.model_name, args.batch_size, args.max_length, args.random_seed, args.window_size, args.preprocess, args.aug)
        print(model_path)
        ...
        output_filepath = "test_reports_final/{}_{}_{}_{}-bs-{}_ml-{}_seed-{}_ws-{}_preprocess-{}_aug-{}.json".format(method, task, serialization, args.model_name, args.batch_size, args.max_length, args.random_seed, args.window_size, args.preprocess, args.aug)
